...
export default function UnifiedFilterPanel(p: Props) {
  return (
    <div className="v78-filter-grid">
      ...
      <Select label="Posted" value={String(p.hours)} onChange={(v) => p.setHours(Number(v))}
        options={[
          { value: "24", label: "Last 24 hours" },
          { value: "72", label: "Last 3 days" },
        ]} />

      <Select label="Source Type" value={p.sourceType} onChange={p.setSourceType}
        options={[
      ...
      <Select label="Agency" value={p.agency} onChange={p.setAgency}
        options={[
      ...
      <Select label="Employment" value={p.employmentDetail} onChange={p.setEmploymentDetail}
        options={[
      ...
      <Select label="Visa" value={p.visaDetail} onChange={p.setVisaDetail}
        options={[
      ...
      <Select label="Experience" value={p.experienceBand} onChange={p.setExperienceBand}
        options={[
      ...
      <Select label="Application Status" value={p.applicationStatus} onChange={p.setApplicationStatus}
        options={[
          { value: "NEW", label: "New" },
